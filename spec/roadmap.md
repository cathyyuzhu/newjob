...
- [ ] 阶段 1：可分发化（首启向导 / 打包 / 剥离个人数据 / LinkedIn 默认关闭 / 补 LICENSE / README 拆成上手版+手册版）——**阶段 0 达标才做**
